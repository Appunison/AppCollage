...
import appunison.androidcrop.R;
...
public class CropImageView extends FrameLayout {
    ...
    public static final int DEFAULT_ASPECT_RATIO_X = 3;
    public static final int DEFAULT_ASPECT_RATIO_Y = 4;
	...
	public void setmCropOverlayView(CropOverlayView mCropOverlayView) {
		this.mCropOverlayView = mCropOverlayView;
	}
